...
- [ADR-0034 — V5 architecture requirements: flexible yield, decoupled rewards, rebasing, mass winner distribution (Proposed)](0034-v5-yield-and-reward-architecture.md)
