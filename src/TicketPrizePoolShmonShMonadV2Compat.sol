...
/// @title TicketPrizePoolShmonShMonadV2Compat
...
contract TicketPrizePoolShmonShMonadV2CompatV2Compat {
    ...
    function getUserPosition(uint256 rid, address user) external view returns (uint128 principalMONOut, uint128 principalShmonSharesOut) {
        return (uint128(principalMON[rid][user]), 0);
    }
